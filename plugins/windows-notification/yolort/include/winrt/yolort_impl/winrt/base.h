...
extern "C"
{
    ...
    int32_t __stdcall FreeLibrary(void* library) noexcept;
    void* __stdcall GetProcAddress(void* library, char const* name) noexcept;

    int32_t __stdcall SetErrorInfo(uint32_t reserved, void* info) noexcept;
    int32_t __stdcall GetErrorInfo(uint32_t reserved, void** info) noexcept;
    int32_t __stdcall CoInitializeEx(void*, uint32_t type) noexcept;
    ...
    winrt::impl::bstr __stdcall SysAllocString(wchar_t const* value) noexcept;
    ...
    void* __stdcall    HeapAlloc(void* heap, uint32_t flags, size_t bytes) noexcept;
    ...
    uintptr_t __stdcall VirtualQuery(void* address, void* buffer, uintptr_t length) noexcept;
    void*    __stdcall EncodePointer(void* ptr) noexcept;
    ...
    int32_t  __stdcall SetThreadpoolTimerEx(winrt::impl::ptp_timer timer, void* time, uint32_t period, uint32_t window) noexcept;
    ...
    int32_t  __stdcall SetThreadpoolWaitEx(winrt::impl::ptp_wait wait, void* handle, void* timeout, void* reserved) noexcept;
...
namespace winrt::impl
{
    ...
    inline shared_hstring_header* precreate_hstring_on_heap(uint32_t length)
    {
        ...
        auto header = static_cast<shared_hstring_header*>(HeapAlloc(GetProcessHeap(), 0, static_cast<std::size_t>(bytes_required)));
...
namespace winrt::impl
{
    ...
    void load_runtime_function(char const* name, F& result, L fallback) noexcept
    {
        ...
        result = reinterpret_cast<F>(GetProcAddress(LoadLibraryW(L"combase.dll"), name));
    ...
    inline int32_t __stdcall fallback_RoGetAgileReference(uint32_t, winrt::guid const& iid, void* object, void** reference) noexcept
    {
        *reference = nullptr;
        ...
        hresult hr = CoCreateInstance(git_clsid, nullptr, 1 /*CLSCTX_INPROC_SERVER*/, guid_of<IGlobalInterfaceTable>(), git.put_void());
...
namespace winrt::impl
{
    ...
    struct error_info_fallback final : IErrorInfo, IRestrictedErrorInfo, update_module_lock
    {
        ...
        {
            *value = SysAllocString(m_message.c_str());
        ...
        int32_t __stdcall GetErrorDetails(bstr* fallback, int32_t* error, bstr* message, bstr* capability) noexcept final
        {
            ...
            *error = m_code;
            *capability = nullptr;
            *message = SysAllocString(m_message.c_str());
...
WINRT_EXPORT namespace winrt
{
    struct hresult_error
    {
        ...
        hresult_error(hresult const code, take_ownership_from_abi_t) noexcept : m_code(verify_error(code))
        {
            ...
            else
            {
                ...
                if (legacy)
                {
                    message = impl::trim_hresult_message(legacy.get(), SysStringLen(legacy.get()));
                }
        ...
        hresult to_abi() const noexcept
        {
            if (m_info)
            {
                SetErrorInfo(0, m_info.try_as<impl::IErrorInfo>().get());
            }
    ...
    private:
        ...
        static int32_t __stdcall fallback_RoOriginateLanguageException(int32_t error, void* message, void*) noexcept
        {
            ...
            WINRT_VERIFY_(0, SetErrorInfo(0, info.get()));
            return 1;
        }
        ...
        void originate(hresult const code, void* message) noexcept
        {
            ...
            com_ptr<impl::IErrorInfo> info;
            WINRT_VERIFY_(0, GetErrorInfo(0, info.put_void()));
    ...
    inline int32_t make_marshaler(unknown_abi* outer, void** result) noexcept
    {
        ...
        private:
            ...
            static com_ptr<IMarshal> get_marshaler() noexcept
            {
                ...
                WINRT_VERIFY_(0, CoCreateFreeThreadedMarshaler(nullptr, unknown.put_void()));
...
WINRT_EXPORT namespace winrt
{
    ...
    private:
        ...
        {
            return event_token{ reinterpret_cast<int64_t>(EncodePointer(get_abi(delegate))) };
        }
...
namespace winrt::impl
{
    ...
    hresult get_runtime_activation_factory(param::hstring const& name, void** result) noexcept
    {
        ...
        {
            auto usage = reinterpret_cast<int32_t(__stdcall*)(void** cookie) noexcept>(GetProcAddress(LoadLibraryW(L"combase.dll"), "CoIncrementMTAUsage"));
        ...
        GetErrorInfo(0, error_info.put_void());
        ...
        while (std::wstring::npos != (count = path.rfind('.')))
        {
            path.resize(count);
            path += L".dll";
            library_handle library(LoadLibraryW(path.c_str()));
            ...
            auto library_call = reinterpret_cast<int32_t(__stdcall*)(void* classId, void** factory)>(GetProcAddress(library.get(), "DllGetActivationFactory"));
...
#error Unsupported architecture: verify that zero-initialization of SLIST_HEADER is still safe
    ...
    struct factory_cache
    {
        ...
        {
            WINRT_ASSERT(entry);
            InterlockedPushEntrySList(&m_list, &entry->m_next);
        }
...
WINRT_EXPORT namespace winrt
{
    ...
    {
        hresult const result = CoInitializeEx(nullptr, static_cast<uint32_t>(type));
    ...
    {
        return try_capture<Interface>(CoCreateInstance, clsid, outer, context);
    }
...
namespace winrt::impl
{
    ...
    {
        if (!TrySubmitThreadpoolCallback(callback, context, nullptr))
        {
            throw_last_error();
        }
    }
    ...
    {
        com_ptr<IContextCallback> m_context = try_capture<IContextCallback>(CoGetObjectContext);
    ...
    {
        if ((context.m_context == nullptr) || (context.m_context == try_capture<IContextCallback>(CoGetObjectContext)))
        {
            handle();
        }
...
WINRT_EXPORT namespace winrt
{
    ...
    [[nodiscard]] inline auto resume_after(Windows::Foundation::TimeSpan duration) noexcept
    {
        struct awaitable : enable_await_cancellation
        {
            ...
            {
                m_handle = handle;
                m_timer.attach(check_pointer(CreateThreadpoolTimer(callback, this, nullptr)));
                int64_t relative_count = -m_duration.count();
                SetThreadpoolTimerEx(m_timer.get(), &relative_count, 0, 0);
        ...
        private:
            ...
            {
                if (SetThreadpoolTimerEx(m_timer.get(), nullptr, 0, 0))
                {
                    int64_t now = 0;
                    SetThreadpoolTimerEx(m_timer.get(), &now, 0, 0);
                }
            }
    ...
    [[nodiscard]] inline auto resume_on_signal(void* handle, Windows::Foundation::TimeSpan timeout = {}) noexcept
    {
        struct awaitable : enable_await_cancellation
        {
            ...
            void await_suspend(impl::coroutine_handle<> resume)
            {
                ...
                SetThreadpoolWaitEx(m_wait.get(), m_handle, file_time, nullptr);
        ...
        private:
            ...
            void fire_immediately() noexcept
            {
                if (SetThreadpoolWaitEx(m_wait.get(), nullptr, nullptr, nullptr))
                {
                    int64_t now = 0;
                    SetThreadpoolWaitEx(m_wait.get(), GetCurrentProcess(), &now, nullptr);
                }
            }
...
namespace winrt::impl
{
    struct natvis
    {
        static auto __stdcall abi_val(void* object, wchar_t const * iid_str, int method)
        {
            ...
            value.s = 0;
            guid iid;
            if (IIDFromString(iid_str, &iid) == 0)
            {
                ...
                if ((VirtualQuery(object, &info, sizeof(info)) != 0) && ((info.protect & 0xEE) != 0))
                {
                    ...
                    if (((unknown_abi*)object)->QueryInterface(iid, reinterpret_cast<void**>(&pinsp)) == 0)
                    {
                        ...
                        if ((VirtualQuery(vtbl, &info, sizeof(info)) != 0) && ((info.protect & 0xEE) != 0))
                        {
                            auto vfunc = vtbl[method + IInspectable_vtbl_size];
                            // validate method pointer is executable
                            if ((VirtualQuery(vfunc, &info, sizeof(info)) != 0) && ((info.protect & 0xF0) != 0))
                            {
